...
pub use pipeline::{
    ...
    HeightmapPlanarConfig, Hybrid2D3D, Hybrid2D3DConfig, IsosurfaceIntersection, Jigsaw,
    JigsawConfig, JigsawTag, KrigingInterpolated, LSystemGrammar, LSystemTrees,
    LatticeBoltzmannD3Q19, LayeredBrickPipeline, LayeredGenerator, LayeredGeology, LbmConfig,
    MacroRiverOnly, MitchellBestCandidate, MitchellConfig, MonolithicTerrainPass,
    NormalizedSparseConvolution, OreVeinConfig, OreVeinStrategy, PerFaceWhittaker, PerlinWorm,
    PlacementStrategy, PoissonDiskBridson, PoissonDiskConfig, Pure3DOverhang, Pure3DOverhangConfig,
    QwfcClassicalSim, SeederConfig, SkyLightConfig, SkyLightStrategy, SparseBlendConfig, Static,
    StaticConfig, StrataBias, StrataConfig, StrataStrategy, StratumBand, StructureStrategy,
    ThresholdNoise, TileDef, TileGeometry, TileSet, TopsoilConfig, TopsoilLayer, TurtleParams,
    UniformGrid, UniformGridConfig, VerticalCastWithDiffusion, VoronoiCells, VoronoiCellsConfig,
    WaveFunctionCollapse, WfcConfig, WhiteNoise, WhiteNoiseConfig, WhittakerDirect2D,
    WhittakerDirect2DConfig, WorldGenConfig, WorldGenPreset, WorleyThreshold, DROPLET_DIM,
    FEATURE_DIM, PLACEMENT_DIM, SKY_LIGHT_DIM, WS_APRON_EDGE,
};
pub use registry::{
